# Server-Befehle: Pricing Update deployen
...
### Pricing Page zeigt alte Version
```bash
# Browser Cache leeren (Strg+Shift+R oder Cmd+Shift+R)
# Oder im Inkognito-Modus testen

# Prüfen ob neue Datei deployed wurde
ls -la .next/server/app/\(marketing\)/pricing/
```
...
- ✅ Pricing-Page: Anchoring-Effekt (219,90€ → 99,90€)
- ✅ Savings-Badge: "SPARE 55%" mit Animation
- ✅ Dringlichkeitstext hinzugefügt
- ✅ Button-Text: "Jetzt Zugang sichern"
- ✅ Admin-Tool: Fix für Tabellen-Übersicht
- ✅ PM2 Config: db-admin hinzugefügt
