            ...
            <div className="grid grid-cols-2 gap-4 md:gap-4 md:max-w-3xl md:mx-auto">
              <Link href="/tools/recipe?tab=week-planner" className={cardClass} style={CARD_STYLE}>
                ...
                <div className="w-full text-left">
                  ...
                  <p className="text-sm text-gray-500 mt-0.5 line-clamp-2 min-h-[2.5rem]">Dein Essensplan</p>
                </div>
              </Link>
              ...
              <Link href="/tools/recipe?tab=my-recipes" className={cardClass} style={CARD_STYLE}>
                ...
                <div className="w-full text-left">
                  ...
                  <p className="text-sm text-gray-500 mt-0.5 line-clamp-2 min-h-[2.5rem]">Deine Favoriten</p>
                </div>
              </Link>
              ...
              <Link href="/tools/recipe" className={cardClass} style={CARD_STYLE}>
                ...
                <div className="w-full text-left">
                  ...
                  <p className="text-sm text-gray-500 mt-0.5 line-clamp-2 min-h-[2.5rem]">Koch-Modus starten</p>
                </div>
              </Link>
              ...
              <Link href="/tools/shopping-list" className={cardClass} style={CARD_STYLE}>
                ...
                <div className="w-full text-left">
                  ...
                  <p className="text-sm text-gray-500 mt-0.5 line-clamp-2 min-h-[2.5rem]">Intelligente Einkaufsplanung</p>
                </div>
              </Link>
            </div>
          </section>
