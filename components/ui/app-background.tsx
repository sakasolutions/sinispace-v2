    ...
    <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden" aria-hidden="true">
      ...
      <div className="pointer-events-none absolute inset-x-0 top-0 h-[50vh] max-h-[50vh] overflow-hidden blur-[120px]">
        <div
          ...
          className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-sini-orange/15 to-sini-pink/15 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
        />
      </div>
    </div>
  );
