        ...
        headerActionsRight={
          <div className="flex flex-col items-end">
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-1.5 px-3 py-1.5 text-xs font-medium rounded-lg bg-white/10 border border-white/20 backdrop-blur-md text-white/90 hover:bg-white/20 transition-all mt-[44px]"
            >
