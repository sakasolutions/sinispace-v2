    ...
    <div className="min-h-[100dvh] flex flex-col w-full relative bg-gray-50">
      ...
      >
        ...
        <div className="relative z-10 w-full pb-20">
          <div className="bg-white/60 backdrop-blur-2xl border border-white/50 shadow-2xl rounded-3xl overflow-hidden min-h-[600px] pt-4 px-4 pb-0 sm:pt-6 sm:px-6 sm:pb-0 md:pt-8 md:px-8 md:pb-0">
