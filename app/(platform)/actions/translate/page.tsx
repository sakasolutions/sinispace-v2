      ...
      <div className="mb-6 sm:mb-8">
        <div className="flex items-start justify-between gap-4">
          ...
          <div className="flex-shrink-0">
            <WhatIsThisModal
              title={toolInfoMap.translate.title}
              content={toolInfoMap.translate.description}
              useCases={toolInfoMap.translate.useCases}
              examples={toolInfoMap.translate.examples}
              tips={toolInfoMap.translate.tips}
            />
          </div>
        </div>
      </div>
          ...
          {state?.result ? (
            <div className="h-full flex flex-col">
              ...
              <div className="p-4 sm:p-5 md:p-6 border-t border-white/5">
                <FeedbackButton 
                  toolId="translate" 
                  toolName="Sprachbrücke"
                  resultId={state.result ? `translate-${Date.now()}` : undefined}
                />
              </div>
            </div>
          ) : (
