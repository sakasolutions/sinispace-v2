...
export async function saveWeeklyPlan(planData: WeeklyPlanEntry[]) {
  ...
  try {
    ...
    // Cast für Server-Build: Prisma-Client kann ältere Typen ohne resultId/isMeal haben
    await prisma.calendarEvent.createMany({ data: rows as never });
